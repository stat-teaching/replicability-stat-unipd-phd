...
```{r}
#| echo: false
hagger2016 <- readRDS(here("slides/03-replication-methods/objects/hagger2016.rds"))
hagger2016
```
...
```{r}
#| echo: false
ghelfi2020 <- readRDS(here("slides/03-replication-methods/objects/ghelfi2020.rds"))
ghelfi2020
```
